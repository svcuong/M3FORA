#' M3-Competition yearly data
#'
#' The yearly time series from the M3 forecasting competition.
#'
#' @format M3 is a list of  2 data.frames of 645 yearly time series from M3-Competition.
#'
...
#'   \item{timesatmp}{The timestamp of series (yearly period)}
#' }
#'
...
#'   \item{category}{The category of series. Possible values for M3 are "DEMOGRAPHIC", "FINANCE", "INDUSTRY",
#'             "MACRO", "MICRO", "OTHER".}
#'   \item{actual}{The future data (test data) or actual values of each time series from M3-Competition yearly data}
#'   \item{method}{The forecasting methods for each time series from M3-Competition yearly data}
#'   \item{forecast}{The forecast values obtained from difference forecasting methods for each time series from M3-Competition yearly data}
#'   \item{horizon}{The forecast horizons for each time series from M3-Competition yearly data}
#'   \item{timesatmp}{The timestamp of series (yearly period)}
#' }
